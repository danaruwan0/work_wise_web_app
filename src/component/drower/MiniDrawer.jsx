...
const AppBar = styled(MuiAppBar, {
  ...
  background: 'linear-gradient(135deg, #764ba2, #7481b9)',
  ...(open && {
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          <IconButton color="inherit" aria-label="open drawer" onClick={handleDrawerOpen} edge="start" sx={{ marginRight: 5, ...(open && { display: 'none' }) }}>
            <MenuIcon sx={{ fontSize: { xs: 20, sm: 24, md: 30 } }}  />
          </IconButton>
          ...
          <IconButton size="large" aria-label="new mails" color="inherit">
            <Badge badgeContent={4} color="error">
              <MailIcon sx={{ fontSize: { xs: 20, sm: 24, md: 30 } }} />
            </Badge>
          </IconButton>

          <IconButton size="large" aria-label="notifications" color="inherit">
            <Badge badgeContent={17} color="error">
              <NotificationsIcon sx={{ fontSize: { xs: 20, sm: 24, md: 30 } }}  />
            </Badge>
          </IconButton>

          <IconButton size="large" edge="end" aria-label="account of current user" color="inherit">
            <AccountCircle sx={{ fontSize: { xs: 20, sm: 24, md: 30 } }}  />
          </IconButton>
